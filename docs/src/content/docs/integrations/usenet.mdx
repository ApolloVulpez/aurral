...
Aurral treats each download client equally. You must configure only one download client for Usenet operation.
...
Change the priorities if you want Aurral to try Usenet or yt-dlp first.
