...
1. Create your admin account. If necessary, enable **Auto-login on local network**.
2. Connect Lidarr (URL and API key), test the connection, then open Aurral.

If the Lidarr stack works, match its media mount. See [Match Lidarr](/getting-started/storage/).
