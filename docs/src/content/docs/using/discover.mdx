...
**More like this** and **Less like this** tune the surrounding taste: they raise or lower related artists without acting as permanent exclusions. **Block artist** is a hard, per-user rule. A blocked artist is removed from Discover recommendations, Discover playlist previews, and future playlist or flow downloads. Manage the list from **Blocked Artists** in the sidebar.
