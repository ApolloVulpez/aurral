...
Browse artists in Lidarr with search, sorting, artwork, monitoring status, and full artist pages.

### Playlists

![Aurral playlists](../../../assets/screenshots/playlists.webp)

This section contains scheduled flows, Spotify imports, discover playlists, in-app playback, and download status.
