...
| Source   | Behavior                                                                  |
| -------- | ------------------------------------------------------------------------- |
| Discover | Aurral's recommendation pool; excludes library and blocked artists        |
| Library  | Artists from your library; the only source allowed to use library artists |
| Trending | Broader trending pools; excludes library and blocked artists              |
| Focus    | Non-library artists matching your tags; excludes blocked artists          |
